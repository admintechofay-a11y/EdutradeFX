...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('bg-primary border-b border-border', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      'border-t border-border bg-secondary font-medium text-text-primary',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-4 text-left align-middle text-xs font-bold uppercase tracking-wider text-text-muted [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
